        ...
        >
          ...
          <TitanCard className="p-8 shadow-2xl border-0 ring-1 ring-black/5 bg-white">
            <div className="text-center mb-6">
              <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-green-50 text-green-700 rounded-full text-xs font-semibold">
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={isLoading}
                className="w-full p-5 rounded-xl border-2 border-slate-200 hover:border-blue-500 hover:bg-blue-50/50 transition-all text-left group"
